...
<body>
            ...
            <nav>
                ...
                <div class="collapse" id="menuDesplegable">
                    <div class="dropdown-menu p-2">
                        <a class="dropdown-item" href="#">Monitorear</a>
    ...
    <main class="container text-center my-5">
        <h3 class="mb-3">¿Qué le gustaría hacer hoy?</h3>
        <div id="clock"></div>

        <div class="row justify-content-center my-4">
            <div class="col-md-3">
                <button class="btn btn-outline-dark btn-custom w-100">CHATS</button>
            </div>
            <div class="col-md-3">
                <button class="btn btn-outline-dark btn-custom w-100">SUBIR ARCHIVO</button>
            </div>
            <div class="col-md-3">
                <button class="btn btn-outline-dark btn-custom w-100">EXÁMENES</button>
            </div>
            <div class="col-md-3">
                <button class="btn btn-outline-dark btn-custom w-100">¿CONTACTAR CON HELP-DESK?</button>
            </div>
        </div>
    </main>
