...
<body>
    ...
    <main class="container text-center my-5">
        ...
        <h3 class="mb-3"> GESTIONES </h3>

        <div class="row justify-content-center my-4">
            <div class="col-md-3">
                <button onclick="subirArchivo()" class="btn btn-outline-dark btn-custom w-100">SALIR</button>
            </div>
            <div class="col-md-3">
                <button onclick="Examenes.php" class="btn btn-outline-dark btn-custom w-100">MODIFICAR</button>
            </div>
            <div class="col-md-3">
                <button onclick="HelpDesk.php" class="btn btn-outline-dark btn-custom w-100">CHATS</button>
            </div>
        </div>
    </main>
